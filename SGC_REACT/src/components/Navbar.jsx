...
import '../index.css'
import miLogo from '../assets/castillo_logo.jpg';

export function Navbar() {
    return (
        <nav id="nav-bar" className="bg-[#3b3c3e] shadow-sm border-b-10 border-[#ec4444]">
                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="text-right">
                            <p className="text-sm text-whitesmoke text-shadow-black font-bold uppercase">
                                Ramses Barreto
                            </p>
                        ...
                        <div>
                            <button className="flex items-center space-x-2 text-[#ec4444] rounded-full">
                                <div className="h-8 w-8 rounded-full bg-[#ec4444] flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#3b3c3e]" fill="currentColor" viewBox="0 0 16 16">
