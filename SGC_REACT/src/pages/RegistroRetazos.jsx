    ...
    />
        ...
        <main className="relative z-10 flex-1 flex justify-center items-center px-4 py-8">
          ...
          {/* Formulariopsa */}
            ...
            <p className="text-gray-300">Ingresa la información del retazo de tela</p>
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
            <label htmlFor="tipoTela" className="block text-sm font-medium text-gray-300 mb-2">
                Tipo de Tela
            </label>
            <select
                id="tipoTela"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="largo" className="block text-sm font-medium text-gray-300 mb-2">
                    Largo (metros)
                    </label>
                    <input
                    type="number"
                ...
                <div>
                <label htmlFor="alto" className="block text-sm font-medium text-gray-300 mb-2">
                Alto (metros)
                </label>
                <input
                    type="number"
